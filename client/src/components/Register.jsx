  ...
  return (
    <MainLayout>
        <div className='flex justify-evenly px-4 py-3 md:px-10 md:py-20 flex-wrap'>
         <div className=' md:w-11/12 max-w-full md:max-w-[650px] p-4 md:p-4 rounded-3xl bg-white border-2 border-gray-100 m-auto'>
            <h1 className='text-2xl md:text-5xl font-semibold'>Hi👋, Welcome to Walify</h1>
            <p className='font-medium text-base md:text-lg text-gray-500 mt-4'>Please enter your details to Create Your Account</p>
            <div className='mt-8'>
            <div className='flex flex-col mt-4'>
                ...
                <div className='mt-8 flex justify-center items-center'>
                    ...
                    <button className='ml-2 font-medium text-base text-violet-500'><Link to= "/join">Sign in</Link></button>
                </div>
            </div>
        </div>
        <div className='hidden md:block'>
            <img className=' w-[500px] rounded-lg shadow-md' src={loginImage} alt="" />
        </div>
    </div>
    </MainLayout>
  )
